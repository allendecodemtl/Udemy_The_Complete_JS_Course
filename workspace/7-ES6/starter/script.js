...
// // ES5
// console.log(firstName + ' ' + lastName + ' ' + calAge(yearOfBirth));

// // ES6
// console.log(`This is ${firstName} ${lastName}. He was born in ${yearOfBirth}.  Today he is ${calAge(yearOfBirth)}`);
...
//     boxesArrs[i].textContent = 'I changed the blue';
// }

// ES6
// for(const cur of boxesArrs){
